...
export function magicLink(data) {
  return `<!doctype html>
    <html lang="en">
      <head>
        <meta charset="utf-8">
            ...
            <tr>
              <td style="padding-bottom: 20px;">
                  <a style="padding: 10px 20px;
                    ...
                    font-size: 16px;
                    text-decoration: none;" href="${data.url}/verify?token=${data.token}">${lang.buttonLabel[data.lang]}</a>
              </td>
            </tr>
    
            <tr>
              <td >
                <p><a href="${data.url}/verify?token=${data.token}" style="text-decoration: underline!important; font-size: 15px;">${data.url}/verify?token=${data.token}</a></p>
