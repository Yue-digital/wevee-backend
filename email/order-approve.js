...
const lang = {
  ...
  reminder:{
    en: 'We are pleased to inform you that your order has been approved by your employer. They will be in contact to arrange delivery.',
    de: 'Wir freuen uns, Ihnen mitteilen zu können, dass Ihre Bestellung von Ihrem Arbeitgeber genehmigt wurde. Er wird sich mit Ihnen in Verbindung setzen, um die Lieferung zu vereinbaren.'
  },
  noReplyLabel:{
...
export function orderApproved(data) {
  return `<!doctype html>
    <html lang="en">
      <head>
        <meta charset="utf-8">
