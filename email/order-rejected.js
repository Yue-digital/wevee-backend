...
const lang = {
  ...
  reminder:{
    en: 'We regret to inform you that your order has not been approved by your employer. They will contact you directly with more information.',
    de: 'Wir bedauern, Ihnen mitteilen zu müssen, dass Ihre Bestellung von Ihrem Arbeitgeber nicht genehmigt wurde. Dieser wird sich mit weiteren Informationen direkt an Sie wenden.'
  },
  noReplyLabel:{
...
export function orderRejected(data) {
  return `<!doctype html>
    <html lang="en">
      <head>
        <meta charset="utf-8">
          ...
          <div style="background-color: #0F1C37; border-top-left-radius: 10px; border-top-right-radius: 10px; display: flex; padding: 20px 15px;"> 
            ...
            <tr>
              <td class="title_wrap" style="padding-bottom: 20px;">
                <h1 style="font-size: 26px; margin: 0px; font-weight: 500;">${lang.heading[data.lang]}</h1>
              </td>
            </tr>
    
            <tr>
              <td >
                <p>${lang.reminder[data.lang]}</p>
    
                <p>${lang.noReplyLabel[data.lang]}</p>
