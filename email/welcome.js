const lang = {
  heading: {
    en: 'Please use this link to register.',
    de: 'Bitte benutzen Sie diesen Link, um sich zu registrieren.'
  },
  buttonLabel: {
    en: 'Register',
    de: 'Registrierung'
            ...
            <tr>
              <td style="padding-bottom: 20px;">
                  <a style="padding: 10px 20px;
                    ...
                    font-size: 16px;
                    text-decoration: none;" href="${data.url}/register">${lang.buttonLabel[data.lang]}</a>
              </td>
            </tr>
    
            <tr>
              <td >
                <p><a href="${data.url}/register" style="text-decoration: underline!important; font-size: 15px;">${data.url}/register</a></p>
                
                <p style="margin: 15px 0 8px 0">${lang.reminder[data.lang]}</p>

                <p style="margin: 15px 0 8px 0">${lang.noReplyLabel[data.lang]}</p>
              </td>
            </tr>
