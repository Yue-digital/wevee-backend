const orderSummaryTemplate = (tasslinkUserDetails, orderDetails) => {
  let user = {
    age: tasslinkUserDetails.alter,
    state: tasslinkUserDetails.bundesland,
    gross_wage: tasslinkUserDetails.bruttolohn,
    tax_class: tasslinkUserDetails.steuerklasse,
    tax_exempt_amount: tasslinkUserDetails.steuerfreibetrag || 0,
    children: tasslinkUserDetails.kinder,
    child_allowance: tasslinkUserDetails.kinderzuschlag,
    church_tax: tasslinkUserDetails.kirchensteuer,
    health_insurance: tasslinkUserDetails.krankenversicherung,
    basic_tariff_private_health_insurance:
      tasslinkUserDetails.basistarif_privat_krankenkasse,
    contribution_private_care_fund:
      tasslinkUserDetails.beitrag_privat_pflegekasse,
    contribution_private_health_insurance:
      tasslinkUserDetails.beitrag_privat_krankenkasse,
    base_rate_health_insurance: tasslinkUserDetails.basissatz_krankenkasse,
    supplement_health_insurance: tasslinkUserDetails.zusatzsatz_krankenkasse,
    pension_insurance: tasslinkUserDetails.rentenversicherung,
    arrival_kilometres: tasslinkUserDetails.anfahrt_kilometer,
    journeys_number: tasslinkUserDetails.anfahrt_anzahl,
    spousal_factor: tasslinkUserDetails.ehegattenfaktor,
    auto_leasingrate_verteilung_ag_an:
      tasslinkUserDetails.auto_leasingrate_verteilung_ag_an,
  };
  ...
  let leasingkonditionen_line = `<td class="td_right">36 Monate /${orderDetails?.annualKm
    ?.replace("overall_", "")
    .replace("k", "")},000 km pro Jahr</td>`;
  return (
    `<html lang="en">
      <head>
        <meta charset="utf-8">
        ...
        <style type="text/css">
          ...
          .cta { padding: 10px 30px; border: none; }
          ...
          <table class="tbl_wrap" bgcolor="#ffffff" width="900" style="padding-left: 40px; padding-right: 40px;">
            <tr>
                <td class="logo_wrap"  style="vertical-align:top; padding-bottom: 20px; padding-top: 40px;" >
                    <img src="https://res.cloudinary.com/dlvqvkxc3/image/upload/v1696568898/379966610_1338769030360396_3964290858873928488_n_mavj7o.png" style="width: 200px;">
                </td>
              </tr>
        ...
        <tr class="col2_tbl_wrap">
          <td class="tbl_col tbl_col_left" colspan="3" style="padding-right: 20px;" >
            <table class="inner_table">
                <tr>
                  <td>Marke</td>
                  <td class="td_right">${orderDetails?.brand}</td>
                </tr>

                <tr>
                  <td>Modell</td>
                  <td class="td_right">${orderDetails?.model}</td>
                </tr>

                <tr>
                  <td>Listenpreis Fahrzeug:</td>
                  <td class="td_right">€ ${formatPrice(
                    orderDetails?.listPrice
                  )} brutto</td>
                </tr>

                <tr>
                  <td>Leasingkonditionen:</td>${leasingkonditionen_line}
                </tr>

                <tr>
                  <td>all-inkl. Leasingrate:</td>
                  <td class="td_right">€ ${formatPrice(
                    orderDetails?.monthlyPayment
                  )} (netto) €  ${formatPrice(
      orderDetails?.tasslinkResponse?.ag_normal_gehalt
    )} (brutto)</td>
                </tr>
    ...
    `
            ...
            <table class="inner_table">
                ...
                <tr>
                  ...
                  <td class="bg_gray">€ ${formatPrice(
                    orderDetails?.tasslinkResponse?.an_normal_gesamtbrutto
                  )}</td>
                  <td class="bg_yellow">€ ${formatPrice(
                    orderDetails?.tasslinkResponse?.an_fw_gesamtbrutto
                  )}</td>
                </tr>
                ...
                <tr>
                  ...
                  <td>€ 0</td>
                  <td>€ ${formatPrice(
                    orderDetails?.tasslinkResponse
                      ?.an_fw_bs_brutto_gehaltsverzicht
                  )}</td>
                </tr>
                 ...
                 <tr>
                  ...
                  <td>€ ${formatPrice(
                    orderDetails?.tasslinkResponse
                      ?.an_fw_bs_brutto_gwv_ein_prozent
                  )}</td>
                </tr>
                ...
                <tr>
                  ...
                  <td>€ ${formatPrice(
                    orderDetails?.tasslinkResponse
                      ?.an_fw_bs_brutto_gwv_nullkommanulldrei_prozent
                  )}</td>
                </tr>
      ...
      <table class="tbl_wrap" bgcolor="#ffffff" width="900" style="padding-left: 40px; padding-right: 40px;">
        ...
        <tr class="col3_tbl_wrap">
          <td class="tbl_col col1 tbl_col_left" colspan="3">
            <table class="inner_table">
                <tr>
                  <td class="bg_gray td_first"><strong>Berechnungsgrundlage (Steuer- und Sozialversicherungsbeiträge Arbeitnehmer)</strong></td>
                  <td class="bg_gray">€ ${formatPrice(
                    orderDetails?.tasslinkResponse?.an_normal_steuerbrutto
                  )}</td>
                  <td class="bg_yellow">${formatPrice(
                    orderDetails?.tasslinkResponse?.an_fw_steuerbrutto
                  )}</td>
                </tr>
                ...
                <tr>
                  ...
                  <td>€ ${formatPrice(
                    orderDetails?.tasslinkResponse?.an_normal_gesamtsteuer
                  )}</td>
                  <td>€ ${formatPrice(
                    orderDetails?.tasslinkResponse?.an_fw_gesamtsteuer
                  )}</td>
                </tr>
                 ...
                 <tr>
                  ...
                  <td>€ ${formatPrice(
                    orderDetails?.tasslinkResponse?.an_normal_sozialversicherung
                  )}</td>
                  <td>€ ${formatPrice(
                    orderDetails?.tasslinkResponse?.an_fw_sozialversicherung
                  )}</td>
                </tr>
                ...
                <tr>
                  ...
                  <td>€ ${formatPrice(
                    orderDetails?.tasslinkResponse
                      ?.an_fw_bs_netto_gwv_ein_prozent +
                      orderDetails?.tasslinkResponse
                        ?.an_fw_bs_netto_gwv_nullkommanulldrei_prozent
                  )}</td>
                </tr>
                ...
                <tr>
                  ...
                  <td></td>
                  <td>€ ${formatPrice(
                    orderDetails?.tasslinkResponse?.an_fw_bs_netto_ausgleich_alv
                  )}</td>
                </tr>
                ...
                <tr>
                  ...
                  <td></td>
                  <td>€ ${formatPrice(
                    orderDetails?.tasslinkResponse?.an_fw_bs_netto_ausgleich_ktg
                  )}</td>
                </tr>
       ...
       <table class="tbl_wrap" bgcolor="#ffffff" width="900" style="padding-left: 40px; padding-right: 40px;">
        ...
        <tr class="col3_tbl_wrap">
          <td class="tbl_col col1 tbl_col_left" colspan="3">
            <table class="inner_table">
                <tr>
                  <td class="bg_gray td_first"><strong>Auszahlbetrag  p.M.</strong></td>
                  <td class="bg_gray">€ ${formatPrice(
                    orderDetails?.tasslinkResponse?.an_normal_auszahlbetrag
                  )}</td>
                  <td class="bg_yellow">€ ${formatPrice(
                    orderDetails?.tasslinkResponse?.an_fw_auszahlbetrag
                  )}</td>
                </tr>
                ...
                <tr>
                  ...
                  <td> ${formatPrice(
                    orderDetails?.tasslinkResponse?.ag_fw_kosten_leasingrate
                  )}</td>
                  <td>€ 0</td>
                </tr>
            </table>
        ...
        <tr class="col3_tbl_wrap">
          <td class="tbl_col col1 tbl_col_left" colspan="3">
            <table class="inner_table">
                ...
                <tr>
                  <td class="td_first">Vorteil/Nachteil</td>
                  <td></td>
                  <td class="bg_yellow">€ pro Mona</td>
                </tr>

                 <tr>
                  <td class="td_first">Vorteil/Nachteil</td>
                  <td></td>
                  <td class="bg_yellow">€ pro Jahr</td>
                </tr>
      ...
      <table class="tbl_wrap" bgcolor="#ffffff" width="900" style="padding-left: 40px; padding-right: 40px;">
        <tr class="ftr" >
          <td style="font-size: 13px; padding-top: 30px;">
            <p style="margin-bottom: 0;font-size: 12px;">The below ADAC link displays the average costs a vehicle owner incurs on a monthly basis, such as running costs, fixed costs, workshop costs, etc. The information allows for an unbiased comparison between the monthly costs incurred for a vehicle of the same brand/model/trim versus the cost-benefit of choosing the monthly WeVee package (which includes maintenance, insurance, workshop costs). And of course your brand new electric vehicle.</p>
          </td>
        </tr>
      </table>
